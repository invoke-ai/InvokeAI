...
def test_create_sessions_from_batch_with_runs(batch_data_collection, batch_graph):
    ...
    assert t[0][0]["nodes"]["1"]["prompt"] == "Banana sushi"
    assert t[0][0]["nodes"]["2"]["prompt"] == "Strawberry sushi"
    assert t[0][0]["nodes"]["3"]["prompt"] == "Orange sushi"
    assert t[0][0]["nodes"]["4"]["prompt"] == "Nissan"

    assert t[1][0]["nodes"]["1"]["prompt"] == "Banana sushi"
    assert t[1][0]["nodes"]["2"]["prompt"] == "Strawberry sushi"
    assert t[1][0]["nodes"]["3"]["prompt"] == "Apple sushi"
    assert t[1][0]["nodes"]["4"]["prompt"] == "Nissan"

    assert t[2][0]["nodes"]["1"]["prompt"] == "Grape sushi"
    assert t[2][0]["nodes"]["2"]["prompt"] == "Blueberry sushi"
    assert t[2][0]["nodes"]["3"]["prompt"] == "Orange sushi"
    assert t[2][0]["nodes"]["4"]["prompt"] == "Nissan"

    assert t[3][0]["nodes"]["1"]["prompt"] == "Grape sushi"
    assert t[3][0]["nodes"]["2"]["prompt"] == "Blueberry sushi"
    assert t[3][0]["nodes"]["3"]["prompt"] == "Apple sushi"
    assert t[3][0]["nodes"]["4"]["prompt"] == "Nissan"

    # repeat for second run
    assert t[4][0]["nodes"]["1"]["prompt"] == "Banana sushi"
    assert t[4][0]["nodes"]["2"]["prompt"] == "Strawberry sushi"
    assert t[4][0]["nodes"]["3"]["prompt"] == "Orange sushi"
    assert t[4][0]["nodes"]["4"]["prompt"] == "Nissan"

    assert t[5][0]["nodes"]["1"]["prompt"] == "Banana sushi"
    assert t[5][0]["nodes"]["2"]["prompt"] == "Strawberry sushi"
    assert t[5][0]["nodes"]["3"]["prompt"] == "Apple sushi"
    assert t[5][0]["nodes"]["4"]["prompt"] == "Nissan"

    assert t[6][0]["nodes"]["1"]["prompt"] == "Grape sushi"
    assert t[6][0]["nodes"]["2"]["prompt"] == "Blueberry sushi"
    assert t[6][0]["nodes"]["3"]["prompt"] == "Orange sushi"
    assert t[6][0]["nodes"]["4"]["prompt"] == "Nissan"

    assert t[7][0]["nodes"]["1"]["prompt"] == "Grape sushi"
    assert t[7][0]["nodes"]["2"]["prompt"] == "Blueberry sushi"
    assert t[7][0]["nodes"]["3"]["prompt"] == "Apple sushi"
    assert t[7][0]["nodes"]["4"]["prompt"] == "Nissan"
