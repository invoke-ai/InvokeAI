...
def _prepare_gallery_router_test(monkeypatch: Any, mock_invoker: Invoker) -> tuple[MagicMock, MagicMock]:
    ...
    return list_items, list_item_names


@pytest.mark.parametrize(
    ("path", "service_index"),
    [("/api/v1/gallery/items/", 0), ("/api/v1/gallery/items/names", 1)],
)
