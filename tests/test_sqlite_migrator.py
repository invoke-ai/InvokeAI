...
def test_migration_34_adds_workflow_call_columns_to_session_queue(logger: Logger) -> None:
    from invokeai.app.services.shared.sqlite_migrator.migrations.migration_34 import Migration34Callback
    ...
    migration_callback = Migration34Callback()
    migration_callback(cursor)
    db._conn.commit()
