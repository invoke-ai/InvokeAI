...
def process_controlnet_image(image_name: str, model_key: str) -> Optional[dict[str, Any]]:
    """
        ...
        if model_key:
            ...
            if control.image_name is not None:
                ...
                if image_data:
                    ...
                    processed_image_data = process_controlnet_image(control.image_name, model_key)
