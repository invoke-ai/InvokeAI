...
async def reidentify_model(
    ...
    _: AdminUserOrDefault = Depends(AdminUserOrDefault),
) -> AnyModelConfig:
...
async def prune_model_install_jobs(_: AdminUserOrDefault = Depends(AdminUserOrDefault)) -> Response:
...
async def empty_model_cache(_: AdminUserOrDefault = Depends(AdminUserOrDefault)) -> None:
...
async def reset_hf_token(_: AdminUserOrDefault = Depends(AdminUserOrDefault)) -> HFTokenStatus:
