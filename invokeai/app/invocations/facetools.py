...
@invocation("face_off", title="FaceOff", tags=["image", "faceoff", "face", "mask"], category="segmentation", version="1.2.2")
...
@invocation("face_mask_detection", title="FaceMask", tags=["image", "face", "mask"], category="segmentation", version="1.2.2")
...
@invocation(
    "face_identifier", title="FaceIdentifier", tags=["image", "face", "identifier"], category="segmentation", version="1.2.2"
)
