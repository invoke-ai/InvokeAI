...
class InvokeAIAppConfig(BaseSettings):
    ...
    Attributes:
        ...
        disable_lora_patching_opt: Disable LoRA patching optimization.
    ...
    disable_lora_patching_opt:     bool = Field(default=False,              description="Disable LoRA patching optimization.")
