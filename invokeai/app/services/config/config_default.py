...
class InvokeAIAppConfig(BaseSettings):
    ...
    # EXTERNAL PROVIDERS
    external_fal_api_key: Optional[str] = Field(default=None, description="API key for fal.ai image generation.")
    external_fal_base_url: Optional[str] = Field(
        default=None, description="Base URL override for fal.ai queue API.",
    )
