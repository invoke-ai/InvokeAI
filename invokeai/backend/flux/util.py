...
from invokeai.backend.model_manager.taxonomy import AnyVariant, ModelVariantType
...
_flux_max_seq_lengths: dict[AnyVariant, Literal[256, 512]] = {
    ModelVariantType.FluxDev: 512,
    ModelVariantType.FluxDevFill: 512,
    ModelVariantType.FluxSchnell: 256,
}
...
_flux_transformer_params: dict[AnyVariant, FluxParams] = {
    ModelVariantType.FluxDev: FluxParams(
        in_channels=64,
        vec_in_dim=768,
        context_in_dim=4096,
        hidden_size=3072,
    ...
    ModelVariantType.FluxSchnell: FluxParams(
        in_channels=64,
        vec_in_dim=768,
        context_in_dim=4096,
        hidden_size=3072,
    ...
    ModelVariantType.FluxDevFill: FluxParams(
        in_channels=384,
        out_channels=64,
        vec_in_dim=768,
        context_in_dim=4096,
