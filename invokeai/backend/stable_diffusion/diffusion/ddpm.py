...
from ..diffusionmodules.util import extract_into_tensor, make_beta_schedule, noise_like
...
class LatentDiffusion(DDPM):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.cond_stage_model.set_textual_inversion_manager(
            self.textual_inversion_manager
        )
