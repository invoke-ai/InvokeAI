...
pid_decoder_flux_2kto4k = StarterModel(
    ...
    base=BaseModelType.Flux,
    source="nvidia/PiD::checkpoints/PiD_v1pt5_res2kto4k_sr4x_official_flux_distill_4step/model_ema_bf16.pth",
    description="NVIDIA PiD 4x super-resolution decoder for FLUX latents, 2K-to-4K preset (v1.5, recommended; the legacy 2K-to-4K checkpoint is deprecated). ~5GB",
    type=ModelType.PiDDecoder,
    format=ModelFormat.Checkpoint,
...
pid_decoder_flux2_2kto4k = StarterModel(
    ...
    base=BaseModelType.Flux2,
    source="nvidia/PiD::checkpoints/PiD_v1pt5_res2kto4k_sr4x_official_flux2_distill_4step/model_ema_bf16.pth",
    description="NVIDIA PiD 4x super-resolution decoder for FLUX.2 Klein latents, 2K-to-4K preset (v1.5, recommended; the legacy 2K-to-4K checkpoint is deprecated). ~5GB",
    type=ModelType.PiDDecoder,
    format=ModelFormat.Checkpoint,
    variant=PiDDecoderVariantType.Res2kTo4k_Sr4x,
    dependencies=[gemma2_2b_encoder],
...
pid_decoder_qwenimage_2kto4k = StarterModel(
    ...
    source="nvidia/PiD::checkpoints/PiD_v1pt5_res2kto4k_sr4x_official_qwenimage_distill_4step/model_ema_bf16.pth",
    description="NVIDIA PiD 4x super-resolution decoder for Qwen-Image latents, 2K-to-4K preset (v1.5, recommended; the legacy 2K-to-4K checkpoint is deprecated). ~5GB",
    type=ModelType.PiDDecoder,
    format=ModelFormat.Checkpoint,
    variant=PiDDecoderVariantType.Res2kTo4k_Sr4x,
    dependencies=[gemma2_2b_encoder],
