...
def _dequantize_comfyui_fp8(sd: dict, compute_dtype: torch.dtype) -> int:
    ...
    Thin wrapper over the shared implementation, which this function's logic was extracted into so
    the Krea-2 loader could stop carrying a divergent copy.
    """
    return dequantize_scaled_fp8(sd, compute_dtype)
