...
export const buildSD1Graph = async (arg: GraphBuilderArg): Promise<GraphBuilderReturn> => {
  ...
  g.upsertMetadata({
    cfg_scale,
    cfg_rescale_multiplier,
    hidiffusion: hiDiffusionEnabled || undefined,
    hidiffusion_raunet: hiDiffusionEnabled ? hiDiffusionRauNetEnabled : undefined,
    hidiffusion_window_attn: hiDiffusionEnabled ? hiDiffusionWindowAttnEnabled : undefined,
