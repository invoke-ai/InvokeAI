...
export const buildSDXLGraph = async (arg: GraphBuilderArg): Promise<GraphBuilderReturn> => {
  ...
  const denoise = g.addNode({
    ...
    hidiffusion_t1_ratio: hiDiffusionEnabled && !hiDiffusionAutoRatios ? hiDiffusionT1Ratio : undefined,
    hidiffusion_t2_ratio: hiDiffusionEnabled && !hiDiffusionAutoRatios ? hiDiffusionT2Ratio : undefined,
    scheduler,
    steps,
  });
  const l2i = g.addNode({
  ...
  g.upsertMetadata({
    ...
    hidiffusion_raunet: hiDiffusionRauNetEnabled,
    hidiffusion_window_attn: hiDiffusionWindowAttnEnabled,
    hidiffusion_t1_ratio: hiDiffusionAutoRatios ? null : hiDiffusionT1Ratio,
    hidiffusion_t2_ratio: hiDiffusionAutoRatios ? null : hiDiffusionT2Ratio,
    steps,
