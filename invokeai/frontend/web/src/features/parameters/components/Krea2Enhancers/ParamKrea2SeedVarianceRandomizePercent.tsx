...
import {
  selectKrea2SeedVarianceRandomizePercent,
...
const ParamKrea2SeedVarianceRandomizePercent = () => {
  ...
  const onChange = useCallback((v: number) => dispatch(setKrea2SeedVarianceRandomizePercent(v)), [dispatch]);

  return (
    <FormControl>
      <InformationalPopover feature="krea2SeedVarianceRandomizePercent">
...
export default memo(ParamKrea2SeedVarianceRandomizePercent);
