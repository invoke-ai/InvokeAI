...
const selectWidth = createSelector(selectSelectedCanvas, (canvas) => canvas.bbox.rect.width);
const selectHeight = createSelector(selectSelectedCanvas, (canvas) => canvas.bbox.rect.height);
