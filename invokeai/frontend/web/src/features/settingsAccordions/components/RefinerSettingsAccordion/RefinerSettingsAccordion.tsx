...
import { selectActiveParams, selectIsRefinerModelSelected } from 'features/controlLayers/store/paramsSlice';
...
const selectBadges = createMemoizedSelector(selectActiveParams, (params) =>
