...
export const TOP_AREA_ID = 'top-area';
export const BOTTOM_GALLERY_PANEL_ID = 'bottom-gallery';
...
// Bottom gallery panel constants
export const BOTTOM_GALLERY_MIN_HEIGHT_PX = 36;
export const BOTTOM_GALLERY_MIN_EXPANDED_HEIGHT_PX = 180;
export const BOTTOM_GALLERY_DEFAULT_HEIGHT_PX = 280;
export const BOARDS_SIDEBAR_MIN_WIDTH_PX = 250;
export const BOARDS_SIDEBAR_DEFAULT_WIDTH_PX = 250;
export const BOARDS_SIDEBAR_MAX_WIDTH_PX = 420;
