...
export const IMAGE_METADATA_ACTION_HANDLERS: ImageMetadataActionHandler[] = [
  ...
  ImageMetadataHandlers.HrfEnabled,
  ImageMetadataHandlers.HrfMethod,
  ImageMetadataHandlers.HrfStrength,
  ImageMetadataHandlers.HrfScale,
  ImageMetadataHandlers.HrfLatentInterpolationMode,
  ImageMetadataHandlers.HrfUpscaleModel,
  ImageMetadataHandlers.HrfTileControlNetModel,
  ImageMetadataHandlers.HrfStructure,
  ImageMetadataHandlers.HrfTileControlWeight,
  ImageMetadataHandlers.HrfTileControlEnd,
  ImageMetadataHandlers.HrfTileSize,
  ImageMetadataHandlers.HrfTileOverlap,
  ImageMetadataHandlers.HrfSteps,
  ImageMetadataHandlers.HrfModel,
  ImageMetadataHandlers.HrfLoraMode,
  ImageMetadataHandlers.HrfLoRAs,
