...
const selectNextEntityIdentifier = createMemoizedSelector(selectSelectedCanvas, (canvas) => {
...
const selectPrevEntityIdentifier = createMemoizedSelector(selectSelectedCanvas, (canvas) => {
  const selectedEntityIdentifier = canvas.selectedEntityIdentifier;
  const allEntities = selectAllEntities(canvas);
