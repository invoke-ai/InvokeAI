...
const selectNextEntityIdentifier = createMemoizedSelector(selectActiveCanvas, (canvas) => {
...
const selectPrevEntityIdentifier = createMemoizedSelector(selectActiveCanvas, (canvas) => {
  const selectedEntityIdentifier = canvas.selectedEntityIdentifier;
  const allEntities = selectAllEntities(canvas);
