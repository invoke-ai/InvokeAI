...
export type components = {
  schemas: {
    ...
    ImageNSFWBlur: {
      ...
      /**
       * Image 
       * @description The image to pass to the NSFW checker
       */
      image?: components["schemas"]["ImageField"];
      /**
       * Active 
       * @description Whether the NSFW checker is active 
       * @default true
       */
      active?: boolean;
    };
