...
export type components = {
  schemas: {
    ...
    ModelLoaderOutput: {
      ...
      /**
       * Clip2 
       * @description Tokenizer and text_encoder submodels (SDXL only)
       */
