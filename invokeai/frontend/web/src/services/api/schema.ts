...
export type components = {
    schemas: {
         ...
         * @enum {string}
         */
        BaseModelType: "any" | "sd-1" | "sd-2" | "sd-3" | "sdxl" | "sdxl-refiner" | "flux" | "cogview4" | "imagen3" | "imagen4" | "chatgpt-4o" | "flux-kontext" | "bria-3";
        /** Batch */
        Batch: {
            /**
             * Batch Id
        ...
        /**
         * BriaControlNetDiffusersConfig
         * @description Model config for Bria/Diffusers ControlNet models.
         */
        BriaControlNetDiffusersConfig: {
            /**
             * Key
        ...
        BriaControlNetField: {
            ...
            /**
             * Mode
             * @description The mode of the ControlNet
             * @enum {string}
             */
            mode: "depth" | "canny" | "colorgrid" | "recolor" | "tile" | "pose";
            /**
             * Conditioning Scale
        ...
        /**
         * ControlNet - Bria
         * @description Collect Bria ControlNet info to pass to denoiser node.
         */
        BriaControlNetInvocation: {
            /**
             * @description The board to save the image to
             * @default null
             */
             ...
             * @default null
             */
            control_image?: components["schemas"]["ImageField"] | null;
            /**
             ...
             * @enum {string}
             */
            control_mode?: "depth" | "canny" | "colorgrid" | "recolor" | "tile" | "pose";
            /**
             * Control Weight
             * @description The weight given to the ControlNet
             * @default 1
            ...
            /**
             * type
             * @default bria_controlnet
             * @constant
             */
            type: "bria_controlnet";
        };
        /**
         * BriaControlNetOutput
         * @description Bria ControlNet info
         */
        BriaControlNetOutput: {
            /** @description ControlNet(s) to apply */
            control: components["schemas"]["BriaControlNetField"];
            /**
             * type
             * @default bria_controlnet_output
             * @constant
             */
            type: "bria_controlnet_output";
        };
        /**
         * Denoise - Bria
         * @description Denoise Bria latents using a Bria Pipeline.
         */
        BriaDenoiseInvocation: {
            /**
             * Id
             * @description The id of this instance of an invocation. Must be unique among all instances of invocations.
             */
            ...
            /**
             * Number of Steps
             * @description The number of steps to use for the denoiser
             * @default 30
             */
            num_steps?: number;
            /**
             * Guidance Scale
             * @description The guidance scale to use for the denoiser
             * @default 5
             */
            ...
            width?: number;
            /**
             * Positive Prompt Embeds
             * @description Positive Prompt Embeds
             * @default null
             */
            pos_embeds?: components["schemas"]["FluxConditioningField"] | null;
            /**
             * Negative Prompt Embeds
             * @description Negative Prompt Embeds
             * @default null
             */
            neg_embeds?: components["schemas"]["FluxConditioningField"] | null;
            /**
             * Latent Noise
             ...
             * @default null
             */
            latent_image_ids?: components["schemas"]["LatentsField"] | null;
            /**
             * ControlNet
             * @description ControlNet
             * @default null
             */
            control?: components["schemas"]["BriaControlNetField"] | components["schemas"]["BriaControlNetField"][] | null;
            /**
             * type
             * @default bria_denoise
             * @constant
             */
            type: "bria_denoise";
        };
        /** BriaDenoiseInvocationOutput */
        BriaDenoiseInvocationOutput: {
            /** @description Latents tensor */
            ...
            /**
             * type
             * @default bria_denoise_output
             * @constant
             */
            type: "bria_denoise_output";
        };
        /**
         * BriaDiffusersConfig
         * @description Model config for Bria/Diffusers models.
         */
        BriaDiffusersConfig: {
            /**
             * Key
        ...
        /**
         * Latent Noise - Bria
         * @description Generate latent noise for Bria.
         */
        BriaLatentNoiseInvocation: {
            /**
             * Id
             * @description The id of this instance of an invocation. Must be unique among all instances of invocations.
             */
            ...
            /**
             * type
             * @default bria_latent_noise
             * @constant
             */
            type: "bria_latent_noise";
        };
        /**
         * BriaLatentNoiseInvocationOutput
         * @description Base class for nodes that output Bria latent tensors.
         */
        BriaLatentNoiseInvocationOutput: {
            /** @description The latent noise */
            latents: components["schemas"]["LatentsField"];
            /** @description The latent image ids. */
            latent_image_ids: components["schemas"]["LatentsField"];
            /**
             * Height
             * @description The height of the output image
             */
            ...
            /**
             * type
             * @default bria_latent_noise_output
             * @constant
             */
            type: "bria_latent_noise_output";
        };
        /**
         * Latents to Image - Bria
         * @description Decode Bria latents to an image.
         */
        BriaLatentsToImageInvocation: {
            /**
             * Id
             * @description The id of this instance of an invocation. Must be unique among all instances of invocations.
             */
            ...
            /**
             * type
             * @default bria_latents_to_image
             * @constant
             */
            type: "bria_latents_to_image";
        };
        /**
         * Main Model - Bria
         * @description Loads a bria base model, outputting its submodels.
         */
        BriaModelLoaderInvocation: {
            /**
             * Id
             * @description The id of this instance of an invocation. Must be unique among all instances of invocations.
             */
            ...
            /**
             * type
             * @default bria_model_loader
             * @constant
             */
            type: "bria_model_loader";
        };
        /**
         * BriaModelLoaderOutput
         * @description Bria base model loader output
         */
        BriaModelLoaderOutput: {
            /**
             * Transformer
            ...
            /**
             * type
             * @default bria_model_loader_output
             * @constant
             */
            type: "bria_model_loader_output";
        };
        /**
         * Prompt - Bria
         * @description Encode a prompt into a Bria text conditioning tensor.
         */
        BriaTextEncoderInvocation: {
            /**
             * Id
             * @description The id of this instance of an invocation. Must be unique among all instances of invocations.
             */
            ...
            /**
             * type
             * @default bria_text_encoder
             * @constant
             */
            type: "bria_text_encoder";
        };
        /**
         * BriaTextEncoderInvocationOutput
         * @description Base class for nodes that output a Bria text conditioning tensor.
         */
        BriaTextEncoderInvocationOutput: {
            /** @description Conditioning tensor */
            pos_embeds: components["schemas"]["FluxConditioningField"];
            /** @description Conditioning tensor */
            neg_embeds: components["schemas"]["FluxConditioningField"];
            /**
             * type
             * @default bria_text_encoder_output
             * @constant
             */
            type: "bria_text_encoder_output";
        };
        /**
        ...
        InvocationCompleteEvent: {
             ...
             */
            result: components["schemas"]["BooleanCollectionOutput"] | components["schemas"]["BooleanOutput"] | components["schemas"]["BoundingBoxCollectionOutput"] | components["schemas"]["BoundingBoxOutput"] | components["schemas"]["BriaControlNetOutput"] | components["schemas"]["BriaDenoiseInvocationOutput"] | components["schemas"]["BriaLatentNoiseInvocationOutput"] | components["schemas"]["BriaModelLoaderOutput"] | components["schemas"]["BriaTextEncoderInvocationOutput"] | components["schemas"]["CLIPOutput"] | components["schemas"]["CLIPSkipInvocationOutput"] | components["schemas"]["CalculateImageTilesOutput"] | components["schemas"]["CogView4ConditioningOutput"] | components["schemas"]["CogView4ModelLoaderOutput"] | components["schemas"]["CollectInvocationOutput"] | components["schemas"]["ColorCollectionOutput"] | components["schemas"]["ColorOutput"] | components["schemas"]["ConditioningCollectionOutput"] | components["schemas"]["ConditioningOutput"] | components["schemas"]["ControlOutput"] | components["schemas"]["DenoiseMaskOutput"] | components["schemas"]["FaceMaskOutput"] | components["schemas"]["FaceOffOutput"] | components["schemas"]["FloatCollectionOutput"] | components["schemas"]["FloatGeneratorOutput"] | components["schemas"]["FloatOutput"] | components["schemas"]["FluxConditioningCollectionOutput"] | components["schemas"]["FluxConditioningOutput"] | components["schemas"]["FluxControlLoRALoaderOutput"] | components["schemas"]["FluxControlNetOutput"] | components["schemas"]["FluxFillOutput"] | components["schemas"]["FluxKontextOutput"] | components["schemas"]["FluxLoRALoaderOutput"] | components["schemas"]["FluxModelLoaderOutput"] | components["schemas"]["FluxReduxOutput"] | components["schemas"]["GradientMaskOutput"] | components["schemas"]["IPAdapterOutput"] | components["schemas"]["IdealSizeOutput"] | components["schemas"]["ImageCollectionOutput"] | components["schemas"]["ImageGeneratorOutput"] | components["schemas"]["ImageOutput"] | components["schemas"]["ImagePanelCoordinateOutput"] | components["schemas"]["IntegerCollectionOutput"] | components["schemas"]["IntegerGeneratorOutput"] | components["schemas"]["IntegerOutput"] | components["schemas"]["IterateInvocationOutput"] | components["schemas"]["LatentsCollectionOutput"] | components["schemas"]["LatentsMetaOutput"] | components["schemas"]["LatentsOutput"] | components["schemas"]["LoRALoaderOutput"] | components["schemas"]["LoRASelectorOutput"] | components["schemas"]["MDControlListOutput"] | components["schemas"]["MDIPAdapterListOutput"] | components["schemas"]["MDT2IAdapterListOutput"] | components["schemas"]["MaskOutput"] | components["schemas"]["MetadataItemOutput"] | components["schemas"]["MetadataOutput"] | components["schemas"]["MetadataToLorasCollectionOutput"] | components["schemas"]["MetadataToModelOutput"] | components["schemas"]["MetadataToSDXLModelOutput"] | components["schemas"]["ModelIdentifierOutput"] | components["schemas"]["ModelLoaderOutput"] | components["schemas"]["NoiseOutput"] | components["schemas"]["PairTileImageOutput"] | components["schemas"]["SD3ConditioningOutput"] | components["schemas"]["SDXLLoRALoaderOutput"] | components["schemas"]["SDXLModelLoaderOutput"] | components["schemas"]["SDXLRefinerModelLoaderOutput"] | components["schemas"]["SchedulerOutput"] | components["schemas"]["Sd3ModelLoaderOutput"] | components["schemas"]["SeamlessModeOutput"] | components["schemas"]["String2Output"] | components["schemas"]["StringCollectionOutput"] | components["schemas"]["StringGeneratorOutput"] | components["schemas"]["StringOutput"] | components["schemas"]["StringPosNegOutput"] | components["schemas"]["T2IAdapterOutput"] | components["schemas"]["TileToPropertiesOutput"] | components["schemas"]["UNetOutput"] | components["schemas"]["VAEOutput"];
        };
        /**
        ...
        InvocationOutputMap: {
            ...
            bria_controlnet: components["schemas"]["BriaControlNetOutput"];
            bria_denoise: components["schemas"]["BriaDenoiseInvocationOutput"];
            bria_latent_noise: components["schemas"]["BriaLatentNoiseInvocationOutput"];
            bria_latents_to_image: components["schemas"]["ImageOutput"];
            bria_model_loader: components["schemas"]["BriaModelLoaderOutput"];
            bria_text_encoder: components["schemas"]["BriaTextEncoderInvocationOutput"];
