...
export type components = {
  schemas: {
    ...
    InvocationOutputMap: {
      ...
      hand_depth_mesh_graphormer_image_processor: components["schemas"]["HandDepthOutput"];
      ...
      bria_bg_remove: components["schemas"]["ImageOutput"];
