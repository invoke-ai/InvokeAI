...
export type components = {
  schemas: {
    ...
    CLIPVisionDiffusersConfig: {
      ...
      /**
       * Image
       * @description Image to preview model
       */
      image?: string | null;
      /**
       * Type
