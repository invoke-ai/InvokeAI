  ...
  schemas: {
    ...
    FluxDenoiseInvocation: {
      ...
      positive_text_conditioning?:
        | components['schemas']['FluxConditioningField']
        | components['schemas']['FluxConditioningField'][];
      /**
       ...
       */
      redux_conditioning?:
        | components['schemas']['FluxReduxConditioningField']
        | components['schemas']['FluxReduxConditioningField'][]
        | null;
      /**
    ...
    Graph: {
      ...
      nodes?: {
        [key: string]:
          ...
          | components['schemas']['AlphaMaskToTensorInvocation']
          | components['schemas']['ApplyMaskTensorToImageInvocation']
          | components['schemas']['ApplyMaskToImageInvocation']
          ...
          | components['schemas']['BoundingBoxInvocation']
          | components['schemas']['CLIPSkipInvocation']
          | components['schemas']['CV2InfillInvocation']
          | components['schemas']['CalculateImageTilesEvenSplitInvocation']
          | components['schemas']['CalculateImageTilesInvocation']
          | components['schemas']['CalculateImageTilesMinimumOverlapInvocation']
          | components['schemas']['CannyEdgeDetectionInvocation']
          | components['schemas']['CanvasPasteBackInvocation']
          | components['schemas']['CanvasV2MaskAndCropInvocation']
          | components['schemas']['CenterPadCropInvocation']
          | components['schemas']['CogView4DenoiseInvocation']
          | components['schemas']['CogView4ImageToLatentsInvocation']
          | components['schemas']['CogView4LatentsToImageInvocation']
          | components['schemas']['CogView4ModelLoaderInvocation']
          | components['schemas']['CogView4TextEncoderInvocation']
          | components['schemas']['CollectInvocation']
          | components['schemas']['ColorCorrectInvocation']
          | components['schemas']['ColorInvocation']
          | components['schemas']['ColorMapInvocation']
          ...
          | components['schemas']['ContentShuffleInvocation']
          ...
          | components['schemas']['CreateGradientMaskInvocation']
          | components['schemas']['CropImageToBoundingBoxInvocation']
          | components['schemas']['CropLatentsCoreInvocation']
          | components['schemas']['CvInpaintInvocation']
          | components['schemas']['DWOpenposeDetectionInvocation']
          | components['schemas']['DenoiseLatentsInvocation']
          | components['schemas']['DenoiseLatentsMetaInvocation']
          | components['schemas']['DepthAnythingDepthEstimationInvocation']
          ...
          | components['schemas']['FluxControlLoRALoaderInvocation']
          | components['schemas']['FluxControlNetInvocation']
          | components['schemas']['FluxDenoiseInvocation']
          | components['schemas']['FluxDenoiseLatentsMetaInvocation']
          | components['schemas']['FluxFillInvocation']
          | components['schemas']['FluxIPAdapterInvocation']
          | components['schemas']['FluxLoRALoaderInvocation']
          | components['schemas']['FluxModelLoaderInvocation']
          | components['schemas']['FluxReduxInvocation']
          | components['schemas']['FluxTextEncoderInvocation']
          | components['schemas']['FluxVaeDecodeInvocation']
          | components['schemas']['FluxVaeEncodeInvocation']
          | components['schemas']['FreeUInvocation']
          | components['schemas']['GetMaskBoundingBoxInvocation']
          | components['schemas']['GroundingDinoInvocation']
          | components['schemas']['HEDEdgeDetectionInvocation']
          | components['schemas']['HeuristicResizeInvocation']
          | components['schemas']['IPAdapterInvocation']
          | components['schemas']['IdealSizeInvocation']
          | components['schemas']['ImageBatchInvocation']
          ...
          | components['schemas']['ImageGenerator']
          ...
          | components['schemas']['ImageMaskToTensorInvocation']
          | components['schemas']['ImageMultiplyInvocation']
          | components['schemas']['ImageNSFWBlurInvocation']
          | components['schemas']['ImageNoiseInvocation']
          ...
          | components['schemas']['IntegerBatchInvocation']
          | components['schemas']['IntegerCollectionInvocation']
          | components['schemas']['IntegerGenerator']
          ...
          | components['schemas']['InvokeAdjustImageHuePlusInvocation']
          | components['schemas']['InvokeEquivalentAchromaticLightnessInvocation']
          | components['schemas']['InvokeImageBlendInvocation']
          | components['schemas']['InvokeImageCompositorInvocation']
          | components['schemas']['InvokeImageDilateOrErodeInvocation']
          | components['schemas']['InvokeImageEnhanceInvocation']
          | components['schemas']['InvokeImageValueThresholdsInvocation']
          ...
          | components['schemas']['LineartAnimeEdgeDetectionInvocation']
          | components['schemas']['LineartEdgeDetectionInvocation']
          | components['schemas']['LlavaOnevisionVllmInvocation']
          | components['schemas']['LoRACollectionLoader']
          | components['schemas']['LoRALoaderInvocation']
          | components['schemas']['LoRASelectorInvocation']
          | components['schemas']['MLSDDetectionInvocation']
          ...
          | components['schemas']['MaskFromIDInvocation']
          | components['schemas']['MaskTensorToImageInvocation']
          | components['schemas']['MediaPipeFaceDetectionInvocation']
          | components['schemas']['MergeMetadataInvocation']
          | components['schemas']['MergeTilesToImageInvocation']
          | components['schemas']['MetadataFieldExtractorInvocation']
          | components['schemas']['MetadataFromImageInvocation']
          | components['schemas']['MetadataInvocation']
          | components['schemas']['MetadataItemInvocation']
          | components['schemas']['MetadataItemLinkedInvocation']
          | components['schemas']['MetadataToBoolCollectionInvocation']
          | components['schemas']['MetadataToBoolInvocation']
          | components['schemas']['MetadataToControlnetsInvocation']
          | components['schemas']['MetadataToFloatCollectionInvocation']
          | components['schemas']['MetadataToFloatInvocation']
          | components['schemas']['MetadataToIPAdaptersInvocation']
          | components['schemas']['MetadataToIntegerCollectionInvocation']
          | components['schemas']['MetadataToIntegerInvocation']
          | components['schemas']['MetadataToLorasCollectionInvocation']
          | components['schemas']['MetadataToLorasInvocation']
          | components['schemas']['MetadataToModelInvocation']
          | components['schemas']['MetadataToSDXLLorasInvocation']
          | components['schemas']['MetadataToSDXLModelInvocation']
          | components['schemas']['MetadataToSchedulerInvocation']
          | components['schemas']['MetadataToStringCollectionInvocation']
          | components['schemas']['MetadataToStringInvocation']
          | components['schemas']['MetadataToT2IAdaptersInvocation']
          | components['schemas']['MetadataToVAEInvocation']
          | components['schemas']['ModelIdentifierInvocation']
          | components['schemas']['MultiplyInvocation']
          | components['schemas']['NoiseInvocation']
          | components['schemas']['NormalMapInvocation']
          | components['schemas']['PairTileImageInvocation']
          | components['schemas']['PasteImageIntoBoundingBoxInvocation']
          | components['schemas']['PiDiNetEdgeDetectionInvocation']
          ...
          | components['schemas']['RectangleMaskInvocation']
          | components['schemas']['ResizeLatentsInvocation']
          | components['schemas']['RoundInvocation']
          | components['schemas']['SD3DenoiseInvocation']
          | components['schemas']['SD3ImageToLatentsInvocation']
          | components['schemas']['SD3LatentsToImageInvocation']
          ...
          | components['schemas']['Sd3ModelLoaderInvocation']
          | components['schemas']['Sd3TextEncoderInvocation']
          | components['schemas']['SeamlessModeInvocation']
          | components['schemas']['SegmentAnythingInvocation']
          | components['schemas']['ShowImageInvocation']
          | components['schemas']['SpandrelImageToImageAutoscaleInvocation']
          | components['schemas']['SpandrelImageToImageInvocation']
          | components['schemas']['StringBatchInvocation']
          | components['schemas']['StringCollectionInvocation']
          | components['schemas']['StringGenerator']
          ...
          | components['schemas']['TileToPropertiesInvocation']
          | components['schemas']['TiledMultiDiffusionDenoiseLatents']
    ...
    GraphExecutionState: {
      ...
      results?: {
        [key: string]:
          ...
          | components['schemas']['BoundingBoxCollectionOutput']
          | components['schemas']['BoundingBoxOutput']
          | components['schemas']['CLIPOutput']
          | components['schemas']['CLIPSkipInvocationOutput']
          | components['schemas']['CalculateImageTilesOutput']
          | components['schemas']['CogView4ConditioningOutput']
          ...
          | components['schemas']['FloatGeneratorOutput']
          | components['schemas']['FloatOutput']
          | components['schemas']['FluxConditioningOutput']
          | components['schemas']['FluxControlLoRALoaderOutput']
          | components['schemas']['FluxControlNetOutput']
          | components['schemas']['FluxFillOutput']
          | components['schemas']['FluxLoRALoaderOutput']
          | components['schemas']['FluxModelLoaderOutput']
          | components['schemas']['FluxReduxOutput']
          | components['schemas']['GradientMaskOutput']
          | components['schemas']['IPAdapterOutput']
          | components['schemas']['IdealSizeOutput']
          | components['schemas']['ImageCollectionOutput']
          | components['schemas']['ImageGeneratorOutput']
          | components['schemas']['ImageOutput']
          | components['schemas']['ImagePanelCoordinateOutput']
          | components['schemas']['IntegerCollectionOutput']
          | components['schemas']['IntegerGeneratorOutput']
          | components['schemas']['IntegerOutput']
          | components['schemas']['IterateInvocationOutput']
          | components['schemas']['LatentsCollectionOutput']
          | components['schemas']['LatentsMetaOutput']
          | components['schemas']['LatentsOutput']
          | components['schemas']['LoRALoaderOutput']
          | components['schemas']['LoRASelectorOutput']
          | components['schemas']['MDControlListOutput']
          | components['schemas']['MDIPAdapterListOutput']
          | components['schemas']['MDT2IAdapterListOutput']
          ...
          | components['schemas']['MetadataToSDXLModelOutput']
          | components['schemas']['ModelIdentifierOutput']
          | components['schemas']['ModelLoaderOutput']
          | components['schemas']['NoiseOutput']
          | components['schemas']['PairTileImageOutput']
          | components['schemas']['SD3ConditioningOutput']
          ...
          | components['schemas']['StringGeneratorOutput']
          | components['schemas']['StringOutput']
          | components['schemas']['StringPosNegOutput']
          | components['schemas']['T2IAdapterOutput']
          | components['schemas']['TileToPropertiesOutput']
          | components['schemas']['UNetOutput']
          | components['schemas']['VAEOutput'];
      };
      /**
       * Errors
    ...
    ModelInstallJob: {
      ...
      config_out?:
        | (
            | components['schemas']['MainDiffusersConfig']
            | components['schemas']['MainCheckpointConfig']
            | components['schemas']['MainBnbQuantized4bCheckpointConfig']
            | components['schemas']['MainGGUFCheckpointConfig']
            | components['schemas']['VAEDiffusersConfig']
            | components['schemas']['VAECheckpointConfig']
            | components['schemas']['ControlNetDiffusersConfig']
            | components['schemas']['ControlNetCheckpointConfig']
            | components['schemas']['LoRALyCORISConfig']
            | components['schemas']['ControlLoRALyCORISConfig']
            | components['schemas']['ControlLoRADiffusersConfig']
            | components['schemas']['LoRADiffusersConfig']
            | components['schemas']['T5EncoderConfig']
            | components['schemas']['T5EncoderBnbQuantizedLlmInt8bConfig']
            | components['schemas']['TextualInversionFileConfig']
            | components['schemas']['TextualInversionFolderConfig']
            | components['schemas']['IPAdapterInvokeAIConfig']
            | components['schemas']['IPAdapterCheckpointConfig']
            | components['schemas']['T2IAdapterConfig']
            | components['schemas']['SpandrelImageToImageConfig']
            | components['schemas']['CLIPVisionDiffusersConfig']
            | components['schemas']['CLIPLEmbedDiffusersConfig']
            | components['schemas']['CLIPGEmbedDiffusersConfig']
            | components['schemas']['SigLIPConfig']
            | components['schemas']['FluxReduxConfig']
            | components['schemas']['LlavaOnevisionConfig']
            | components['schemas']['ApiModelConfig']
          )
        | null;
      /**
       * Inplace
