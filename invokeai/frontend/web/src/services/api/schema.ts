...
export type components = {
    schemas: {
        ...
        /**
         * Canvas Composite Input
         * @description Provides the flattened canvas raster layer to a workflow.
         */
        CanvasCompositeRasterInputInvocation: {
            /**
             * @description The board to save the image to
             * @default null
             */
            ...
            /**
             * type
             * @default canvas_composite_raster_input
             * @constant
             */
            type: "canvas_composite_raster_input";
        };
        /**
         * Canvas Paste Back
        ...
        /**
         * Canvas Workflow Output
         * @description Designates the workflow image output used by the canvas.
         */
        CanvasWorkflowOutputInvocation: {
            /**
             * @description The board to save the image to
             * @default null
             */
            ...
            /**
             * type
             * @default canvas_workflow_output
             * @constant
             */
            type: "canvas_workflow_output";
        };
        /**
        ...
        InvocationOutputMap: {
            ...
            canvas_composite_raster_input: components["schemas"]["ImageOutput"];
            canvas_paste_back: components["schemas"]["ImageOutput"];
            canvas_v2_mask_and_crop: components["schemas"]["ImageOutput"];
            canvas_workflow_output: components["schemas"]["ImageOutput"];
