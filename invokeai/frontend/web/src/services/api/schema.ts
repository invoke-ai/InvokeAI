...
export type components = {
    schemas: {
        ...
        InvocationOutputMap: {
            ...
            mlsd_edge_detection: components["schemas"]["ImageOutput"];
        ...
        /**
         * MLSD Edge Detection
         * @description Generates an line segment edge map using MLSD.
         */
        MLSDEdgeDetectionInvocation: {
            ...
            /**
             * type
             * @default mlsd_edge_detection
             * @constant
             * @enum {string}
             */
            type: "mlsd_edge_detection";
        };
        /**
