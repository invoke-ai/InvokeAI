...
export type components = {
  schemas: {
    ...
    /**
     * InvokeAI Canvas Paste Back
     * @description Combines two images by using the mask provided
     */
