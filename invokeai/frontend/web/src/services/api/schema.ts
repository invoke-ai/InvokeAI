...
export type components = {
    schemas: {
        ...
        InvocationOutputMap: {
            ...
            test_typegen_invocation: components["schemas"]["ImageOutput"];
        ...
        /**
         * Test Typegen Invocation
         * @description Test typegen ci
         */
        TestTypegenInvocation: {
            /**
             * Id
             * @description The id of this instance of an invocation. Must be unique among all instances of invocations.
             */
            ...
            /**
             * type
             * @default test_typegen_invocation
             * @constant
             * @enum {string}
             */
            type: "test_typegen_invocation";
        };
        /**
