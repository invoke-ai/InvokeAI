  ...
  list_image_dtos: {
    parameters: {
      query?: {
        ...
        limit?: number;
        /** @description The way to sort the images */
        order_by?: components["schemas"]["OrderByOptions"];
