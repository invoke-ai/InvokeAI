...
export type components = {
    schemas: {
        ...
        CLIPField: {
            ...
            /**
             * Structural Loras
             * @description Structural LoRAs to apply on model loading
             */
            structural_loras: components["schemas"]["StructuralLoRAField"][];
        };
        /**
        ...
        /**
         * Flux Structural LoRA Collection Loader
         * @description Applies a collection of LoRAs to a FLUX transformer.
         */
        FluxStructuralLoRACollectionLoader: {
            /**
             * Id
             * @description The id of this instance of an invocation. Must be unique among all instances of invocations.
             */
            ...
            /**
             * Structural LoRAs
             * @description Structural LoRA models and weights. May be a single Structural LoRA or collection.
             * @default null
             */
            loras?: components["schemas"]["StructuralLoRAField"] | components["schemas"]["StructuralLoRAField"][];
            /**
             * Transformer
             * @description Transformer
             * @default null
            ...
            /**
             * type
             * @default flux_structural_lora_collection_loader
             * @constant
             * @enum {string}
             */
            type: "flux_structural_lora_collection_loader";
        };
        /**
         * Flux Structural LoRA
         * @description Apply a LoRA model to a FLUX transformer and/or text encoder.
         */
        FluxStructuralLoRALoaderInvocation: {
            /**
             * Id
             * @description The id of this instance of an invocation. Must be unique among all instances of invocations.
             */
            ...
            /**
             * Structural LoRA
             * @description Structural LoRA model to load
             * @default null
             */
            lora?: components["schemas"]["ModelIdentifierField"];
            /**
            ...
            /**
             * type
             * @default flux_structural_lora_loader
             * @constant
             * @enum {string}
             */
            type: "flux_structural_lora_loader";
        };
        /**
         * FluxStructuralLoRALoaderOutput
         * @description Flux Structural LoRA Loader Output
         */
        FluxStructuralLoRALoaderOutput: {
            /**
             * FLUX Transformer
            ...
            /**
             * type
             * @default flux_structural_lora_loader_output
             * @constant
             * @enum {string}
             */
            type: "flux_structural_lora_loader_output";
        };
        /**
         * FLUX Text Encoding
        ...
        InvocationOutputMap: {
            ...
            flux_structural_lora_collection_loader: components["schemas"]["FluxStructuralLoRALoaderOutput"];
            flux_structural_lora_loader: components["schemas"]["FluxStructuralLoRALoaderOutput"];
         ...
         * @enum {string}
         */
        ModelType: "onnx" | "main" | "vae" | "lora" | "structural_lora" | "controlnet" | "embedding" | "ip_adapter" | "clip_vision" | "clip_embed" | "t2i_adapter" | "t5_encoder" | "spandrel_image_to_image";
        /**
         * ModelVariantType
         * @description Variant type.
         * @enum {string}
        ...
        /** StructuralLoRAField */
        StructuralLoRAField: {
            /** @description Info to load structural lora model */
            lora: components["schemas"]["ModelIdentifierField"];
            /**
             * Weight
             * @description Weight to apply to lora model
        ...
        /**
         * StructuralLoRALyCORISConfig
         * @description Model config for Structural LoRA/Lycoris models.
         */
        StructuralLoRALyCORISConfig: {
            /**
             * Key
            ...
            /**
             * Type
             * @default structural_lora
             * @constant
             * @enum {string}
             */
            type: "structural_lora";
            /**
             * Trigger Phrases
             * @description Set of trigger phrases for this model
             */
