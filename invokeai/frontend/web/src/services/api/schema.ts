...
export type components = {
    schemas: {
        ...
        /**
         * Image Alpha to Outline
         * @description Finds the outline of the alpha channel of an image, expands it and returns just the outline.
         */
        ImageAlphaToOutlineInvocation: {
            /**
             * @description The board to save the image to
             * @default null
             */
            ...
            use_cache?: boolean;
            /**
             * @description The input image. It should have some transparency.
             * @default null
             */
            image?: components["schemas"]["ImageField"];
            /**
        ...
        InvocationOutputMap: {
            ...
            img_alpha_to_outline: components["schemas"]["ImageOutput"];
