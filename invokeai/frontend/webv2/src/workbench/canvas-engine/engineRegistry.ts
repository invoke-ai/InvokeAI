...
import { createCanvasEngine, type CanvasEngine, type CanvasEngineOptions } from '@workbench/canvas-engine/engine';
...
export const createEngineRegistry = (
  ...
  return {
    ...
    getOrCreateEngine: (projectId, deps) => {
      ...
      entries.set(projectId, { disposeHandle: null, engine, refCount: 1 });
      return engine;
    },
