...
const getNodeDepths = (graph: GraphContract): Map<string, number> => {
...
const toPreviewNodes = (graph: GraphContract, positionHints?: Record<string, XYPosition>): PreviewFlowNode[] => {
...
const toPreviewEdges = (graph: GraphContract): FlowEdge[] =>
