...
t2i = T2I(model       = <path>        // models/ldm/stable-diffusion-v1/model.ckpt
          ...
          sampler_name= ['ddim', 'k_dpm_2_a', 'k_dpm_2', 'k_euler_a',
              'k_euler', 'k_heun', 'k_lms', 'plms']  // k_lms
          grid        = <boolean>     // false
...
"""
    ...
    def prompt2png(self, prompt, outdir, **kwargs):
        ...
        pngwriter = PngWriter(outdir, prompt, kwargs.get(
    ...
    def prompt2image(self,
        ...
        print(f'{len(results)} images generated in',
              "%4.2fs" % (toc-tic))
        return results
    ...
    def _txt2img(self,
        ...
        while True:
            ...
            shape = [self.latent_channels, height //
                     self.downsampling_factor, width // self.downsampling_factor]
    ...
    def _get_uc_and_c(self, prompt, batch_size, skip_normalize):
        ...
        if len(subprompts) > 1:
            ...
            for i in range(0, len(subprompts)):
                ...
                c = torch.add(c, self.model.get_learned_conditioning(
                    batch_size * [subprompts[i]]), alpha=weight)
