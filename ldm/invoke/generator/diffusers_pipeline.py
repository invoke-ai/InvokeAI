...
from ..devices import CPU_DEVICE, normalize_device
...
class ConditioningData:
    ...
    """
    postprocessing_settings: PostprocessingSettings | None = None
...
class StableDiffusionGeneratorPipeline(StableDiffusionPipeline):
    ...
    def to(self, torch_device: str | torch.device | None = None):
