...
class Args(object):
    ...
    def dream_prompt_str(self,**kwargs):
        ...
        if a['h_symmetry_point']:
            switches.append(f'--h_symmetry_point {a["h_symmetry_point"]}')
        if a['v_symmetry_point']:
            switches.append(f'--v_symmetry_point {a["v_symmetry_point"]}')
...
def metadata_dumps(opt,
    ...
    rfc266_img_fields = ['type','postprocessing','sampler','prompt','seed','variations','steps',
                         ...
                         'init_img','init_mask','facetool','facetool_strength','upscale','h_symmetry_point',
                         'v_symmetry_point']
    rfc_dict ={}
