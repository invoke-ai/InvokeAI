      ...
      <AccordionItem>
        <h2>
          <AccordionButton>
            ...
            <GuideIcon feature={'SeedAndVariation'} />
            <AccordionIcon />
          </AccordionButton>
        </h2>
        <AccordionPanel>
      ...
      <AccordionItem>
        <h2>
          <AccordionButton>
            ...
            <GuideIcon feature={'FaceCorrection'} />
            <AccordionIcon />
          </AccordionButton>
        </h2>
        <AccordionPanel>
      ...
      <AccordionItem>
        <h2>
          <AccordionButton>
            ...
            <GuideIcon feature={'ImageToImage'} />
            <AccordionIcon />
          </AccordionButton>
        </h2>
        <AccordionPanel>
