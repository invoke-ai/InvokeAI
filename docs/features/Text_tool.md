...
- **Spacing** controls the line height multiplier (Dense, Normal, Spacious). This affects the distance between lines while editing and after commit.

## Uncommitted state

While text is uncommitted, it remains editable on-canvas. The uncommitted block can be moved and rotated:
