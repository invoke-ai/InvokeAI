...
[![project logo](./assets/splash-banner.png)](https://github.com/invoke-ai/InvokeAI)
...
To fix the diagnostic error in MDX, you need to change the autolink syntax `<url>` to standard Markdown link syntax `[url](url)`, as MDX can sometimes misinterpret angle brackets as JSX tags.
