...
<tr>
  ...
  <br />
  <a href="https://www.youtube.com/watch?v=1OeHEJrsTpI" style="color: inherit; text-decoration: inherit;"><img src="https://img.youtube.com/vi/1OeHEJrsTpI/0.jpg" /></a>
  </td>
  <td>
  using advanced generation settings, brief explanation of sampler/scheduler, explanation of Steps and relationship to quality/efficiency, brief explanation of CFG Scale setting
  </td>
</tr>
