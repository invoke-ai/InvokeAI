...
<Aside type="note" title="Operating Systems and GPU Support">
  <Tabs syncKey="operatingSystem">
    <TabItem label="Windows" icon="seti:windows">
      Docker Desktop on Windows [includes GPU support](https://www.docker.com/blog/wsl-2-gpu-support-for-docker-desktop-on-nvidia-gpus/).
    </TabItem>
    <TabItem label="MacOS" icon="apple">
      Docker can not access the GPU on macOS, so your generation speeds will be slow. Use the [launcher](/getting-started/installation) instead.
    </TabItem>
