...
- `invokeai/app/services/config/config_default.py` ensures the configured directory and its `README.txt` exist.
...
2. If the new stack should be the default, update `TEXT_DEFAULT_FONT_ID`.
