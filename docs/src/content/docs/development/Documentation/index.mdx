...
Documentation translations are managed in the [InvokeAI Docs Crowdin project](https://crowdin.com/project/invokeai-docs). English Markdown and MDX files in `src/content/docs` are the source of truth. Crowdin exports German, Spanish, and Hindi pages into locale directories under that same collection, matching [Starlight's internationalized content layout](https://starlight.astro.build/guides/i18n/).
