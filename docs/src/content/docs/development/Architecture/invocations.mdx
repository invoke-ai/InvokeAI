...
import { FileTree, Code, Steps, Aside } from '@astrojs/starlight/components'
...
<Code
  lang="python"
  title="__init__.py"
  code={`from .cool_node import ResizeInvocation`}
/>
