...
The same move implementation is also available through an external Python maintenance script for administrators who need to run startup recovery or start an image move outside the web UI.
