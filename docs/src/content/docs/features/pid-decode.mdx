...
This setting applies to every supported PiD decoder. It reduces peak activation and sampler memory by processing parts of the pixel pathway in chunks, at the cost of slower decoding. It is disabled by default.
