---
title: Multi-User Specification
description: Detailed technical specification for InvokeAI's multi-user support.
sidebar:
  order: 6
---
...
:::note
Email/SMTP configuration is optional. Many administrators will not have ready access to an outgoing SMTP server. When email is not configured, the system provides fallback mechanisms by displaying setup links directly in the admin UI.
:::
