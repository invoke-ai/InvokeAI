...
:::note[Web UI for User Management]
...
:::caution[Command Line Management]
...
- **Documentation**: [InvokeAI Docs](https://invoke.ai/)
...
- **User Guide**: [For Users](/features/multi-user/user-guide/)
- **API Guide**: [For Developers](/features/multi-user/api-guide/)
...
- [User Guide](/features/multi-user/user-guide/) — For end users
- [API Guide](/features/multi-user/api-guide/) — For API consumers
- [Multi-User Specification](/features/multi-user/specification/) — Technical details
