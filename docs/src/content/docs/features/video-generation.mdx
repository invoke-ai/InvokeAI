...
Add `wan_memory_optimization: true` to `invokeai.yaml` and restart Invoke to lower peak VRAM during denoise and untiled VAE decode. This makes generation slower.
